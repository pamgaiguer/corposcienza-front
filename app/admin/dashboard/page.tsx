...
export default function AdminDashboard() {
  ...
  const departmentStats = [
    ...
    { name: "General Medicine", patients: 234, progress: 89, icon: Stethoscope, color: "blue" },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
          <CardHeader>
            ...
            <CardDescription className="text-gray-600 dark:text-gray-400">Frequently used actions</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              {quickActions.map((action, index) => (
                ...
                >
                  <Link href={action.href}>
                    <action.icon className={`mr-3 h-4 w-4 text-${action.color}-600 dark:text-${action.color}-400`} />
            ...
            {departmentStats.map((dept, index) => (
              <div key={index} className="space-y-3">
                <div className="flex items-center space-x-2">
                  <dept.icon className={`h-5 w-5 text-${dept.color}-600 dark:text-${dept.color}-400`} />
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-gray-900 dark:text-white">{dept.patients}</span>
                  </div>
                  <Progress value={dept.progress} className="h-2" />
                  <div className="text-xs text-gray-500 dark:text-gray-400">{dept.progress}% capacity</div>
                </div>
              </div>
            ))}
          </div>

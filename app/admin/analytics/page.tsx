  ...
  return (
    <div className="flex-1 p-8 bg-gray-50 min-h-screen">
      ...
      <motion.div className="mb-8" {...fadeInUp}>
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Insights e métricas dos seus pacientes</p>
          </div>
        ...
        <motion.div {...fadeInUp}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Novos pacientes e receita por mês</CardDescription>
            </CardHeader>
            <CardContent>
              <ChartContainer
                config={{
        ...
        <motion.div {...fadeInUp}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Faixas etárias dos pacientes</CardDescription>
            </CardHeader>
            <CardContent>
              <ChartContainer
                config={{
        ...
        <motion.div {...fadeInUp}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Tipos de planos contratados</CardDescription>
            </CardHeader>
            <CardContent>
              <ChartContainer
                config={{
        ...
        <motion.div {...fadeInUp}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Divisão entre pacientes</CardDescription>
            </CardHeader>
            <CardContent>
              <ChartContainer
                config={{
                ...
                {cityDistribution.map((city, index) => (
                  <div key={city.city} className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <p className="text-sm font-medium text-gray-900">{city.count}</p>
      ...
      <motion.div className="mt-8" {...fadeInUp}>
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Insights Principais</h2>
          ...
          <Card className="border-l-4 border-l-purple-500">
            <CardContent className="p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-600">Alta Retenção</p>
                  <p className="text-lg font-bold text-gray-900">94.2% mantidos</p>
                  <p className="text-xs text-gray-500">Excelente satisfação</p>
                </div>
              </div>
            </CardContent>
          </Card>

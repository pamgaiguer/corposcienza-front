...
export default function HomePage() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      role: 'Paciente',
      content:
        'Mudou minha vida! Finalmente encontrei profissionais que realmente se importam.',
      rating: 5,
    },
  ];
            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
                  Cuidado médico de excelência com abordagem científica e humanizada.
                  Tecnologia avançada a serviço da sua saúde e bem-estar.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Combinamos expertise médica, tecnologia avançada e cuidado humanizado para
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  'Protocolos rigorosos de segurança e privacidade dos dados médicos.',
              },
              {
                icon: Users,
              ...
              },
              {
                ...
                description:
                  'Certificações e reconhecimentos nacionais e internacionais.',
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Oferecemos uma ampla gama de especialidades médicas com os mais altos
      ...
      <section className="py-20 bg-white dark:bg-gray-800">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Depoimentos reais de pessoas que confiaram na Corpo Scienza para cuidar da
              sua saúde.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8">
              Agende sua consulta hoje mesmo e experimente o que há de mais avançado em
